 ...
 */
public class TopRatedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<Movies> movieList;
    private LayoutInflater inflater = null;
    private Uri uri = null;
    private final String TAG = TopRatedRecyclerViewAdapter.class.getSimpleName();

    public TopRatedRecyclerViewAdapter(Context context, List<Movies> movieList) {
        this.context = context;
        this.movieList = movieList;
        inflater = LayoutInflater.from(context);
    }

    public TopRatedRecyclerViewAdapter(Context context) {
        this.context = context;
    }
